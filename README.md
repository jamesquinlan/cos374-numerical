...
| --- | --- |
-->
  ![Lambers ENA MATLAB](lambers.jpg){:style="float: right;margin-right: 7px;margin-top: 7px;"}   Lambers et al., (2018). [Explorations in Numerical Analysis](https://doi.org/10.1142/10446). World Scientific. <br>**Note**: Future edition in Julia, <!-- ISBN: 978-981-320-997-8.  -->
